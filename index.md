* [html和css部分](#html和css部分)
  ...
  * [6\.HTML的块级元素行内元素行内块元素有哪些区别是什么](#6html的块级元素行内元素行内块元素有哪些区别是什么)
...
作用)
  ...
  * [13\.我们在本地工程常会修改一些配置文件，这些文件不需要被提交，而我们又不想每次执行git status时都让这些文件显示出来，我们该如何操作？](#13我们在本地工程常会修改一些配置文件这些文件不需要被提交而我们又不想每次执行git-status时都让这些文
件显示出来我们该如何操作)
